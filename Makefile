export CC=gcc
export CFLAGS=-std=c99 -pthread -O2 -fstrict-aliasing -I/usr/X11/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -pedantic -Werror -Wstrict-aliasing -Wchar-subscripts -Wimplicit -Wsequence-point -Wwrite-strings -Wno-pointer-sign -Wno-parentheses -Wno-unused-result
