...
O=main.o world.o map.o resources.o battle.o movement.o combat.o pathfinding.o interface.o input.o input_map.o input_battle.o display.o image.o format.o json.o dictionary.o vector.o
