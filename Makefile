export CC=gcc
export CFLAGS=-std=c99 -O2 -pthread -I/usr/X11/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -pedantic -Werror -Wchar-subscripts -Wimplicit -Wsequence-point -Wwrite-strings -Wno-pointer-sign -Wno-parentheses -Wno-unused-result
