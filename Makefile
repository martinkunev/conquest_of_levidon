...
all: main.o map.o resources.o interface.o input.o input_map.o input_battle.o display.o image.o format.o json.o dictionary.o vector.o pathfinding.o battlefield.o
	$(CC) $(LDFLAGS) $^ -o map
