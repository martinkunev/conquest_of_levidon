...
map: main.o map.o resources.o interface.o input.o display.o image.o battle.o format.o json.o dictionary.o vector.o
	$(CC) $(LDFLAGS) $^ -o map
...
clean:
	rm -f battle.o format.o main.o resources.o map.o interface.o image.o input.o display.o json.o dictionary.o vector.o
	rm -f map
